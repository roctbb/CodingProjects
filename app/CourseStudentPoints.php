...
class CourseStudentPoints extends Model
{
    ...
    {
        // XP includes all visible course tasks; percent compares earned XP with the common required path.
        $points = 0;
        $max_points = 0;
        $progressPoints = 0;
        $progressMaxPoints = 0;
        ...
        return [
            ...
            'percent' => $progressMaxPoints > 0 ? ($points * 100 / $progressMaxPoints) : 0,
        ];
    }
